...
BLOOMFWD_DIR=/home/alexandrelucchesi/bloomfwd-rand/
...
OUTPUT_FILE=bench/res/mic/ripe/ripe.csv # Benchmark output file.

cd $BLOOMFWD_DIR
mkdir -p bench/res/mic/ripe/

# Clean old data files...
data_files=$(ls bench/res/mic/ripe/)
if [ ${#data_files} -gt 0 ]; then
	rm -f bench/res/mic/ripe/*
fi
