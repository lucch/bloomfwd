...
#DATA_DIR=/home/alexandrelucchesi/ip-datasets/ipv6/basic/as65000
DATA_DIR=/home/alexandrelucchesi/ip-datasets/routeviews-v6/basic/nwax
...
OUTPUT_FILE=bench/res/mic/go.csv # Benchmark output file.
...
# Parallel
distrib=$DATA_DIR/distrib.txt
prefixes=$DATA_DIR/prefixes.txt
