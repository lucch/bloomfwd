...
# Settings
CC=icc
BLOOMFWD_DIR=/home/alexandrelucchesi/Development/c/bloomfwd/ # Host directory.
...
#ALGS_SERIAL=("bloomfwd_mic_intrin")
#ALGS_PARALLEL=("bloomfwd_mic_par_autovec" "bloomfwd_mic_par_intrin")
...
cd $BLOOMFWD_DIR
mkdir -p bench/res-falsep/mic/

# Clean old data files...
data_files=$(ls bench/res-falsep/mic)
if [ ${#data_files} -gt 0 ]; then
	rm -f bench/res-falsep/mic/*
fi
